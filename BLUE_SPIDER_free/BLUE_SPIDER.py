...
def timed_print(*args, **kwargs):
    ...
    time_prefix = (
        f"{blue_color}[{RESET}"                    
        f"\033[38;2;255;255;255m{hour_str}\033[0m" 
        f"\033[38;2;255;255;255m:\033[0m"
        f"\033[38;2;255;255;255m{minute_str}\033[0m" 
        f"\033[38;2;255;255;255m:\033[0m"
        f"\033[38;2;255;255;255m{second_str}\033[0m" 
        f"{blue_color}]{RESET}"                    
    )
...
MENU = [
    {"name": "Tools", "items": [
        {"file": "virusbuilder.py", "title": "Rat Builder"},
        {"file": "spoofer.py", "title": "Spoofer"},
        {"file": "database-SEARCHING.py", "title": "Data Base Searching"},
    ]},
    {"name": "Osint", "items": [
    ...
    {"name": "Network Scan", "items": [
        ...
        {"file": "ip-stresser.py", "title": "ip stresser Tools"},
    ...
    {"name": "Utilities", "items": [
        ...
        {"file": "antigrab.py", "title": "Anti Grabber Tool To Be ON"},
        {"file": "fakevoice.py", "title": "Make Any Prompt To Fake Voice !"},
        {"file": "fraud.py", "title": "Fraud Identity Card Gen"},
        {"file": "obfuscator.py", "title": "obfuscator For Files To not be Detectable FOR 0"},
...
SUB_MENU = [
    {"name": "Discord", "items": [
        ...
        {"file": "discord-id-lookup.py", "title": "Discord Id Infos"},
    ]},
    {"name": "Roblox", "items": [
    ...
    {"name": "Searching", "items": [
        ...
        {"file": "database-SEARCHING.py", "title": "Database Searching Files"},
    ]},
]
...
def build_categories_panel(categories, menu_key):
    ...
    nav_inst = f"({rgb(*WHITE_RGB)}Ctrl+C exit n & k to switch menus{rgb(*BLUE_RGB)})"
