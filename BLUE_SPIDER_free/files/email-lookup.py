...
# Désactiver la tentative d'utilisation de WMI sous Windows
if sys.platform == 'win32':
    os.environ['WMI_DISABLE'] = '1'
    # Alternative : forcer l'utilisation des méthodes standard
    import dns.resolver
    # Forcer l'utilisation du resolver standard
...
def get_email_info(email: str) -> Tuple[Dict[str, Any], Optional[str], Optional[str], Optional[str], Optional[str]]:
    ...
    try:
        ...
        domain_all: Optional[str] = parts[1] 
